				...
				if( 'v2' == $checkout_ver ){
					...
					<div class="panel-heading arrow">
						<h2 class="panel-title">
							<a class="accordion-toggle" data-toggle="collapse" href="#panel-cart-discount" ><?php _e('คูปองส่วนลด', 'porto'); ?></a>
						</h2>
					</div>
				<?php
				}else{
			...
			<?php endif; ?>
						...
						<form class="checkout_coupon" method="post" style="display:none">
							...
							<p class="form-row form-row-last">
								<input type="submit" class="btn btn-default" name="apply_coupon" value="<?php esc_attr_e( 'ใช้คูปอง', 'porto' ); ?>" />
							</p>
