											...
											<div class="panel-group">
												<div class="panel panel-default">
													<div class="panel-heading arrow">
														<h2 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" href="#panel-cart-discount"><?php _e( 'คูปองส่วนลด', 'porto' ); ?></a></h2>
													</div>
													<div id="panel-cart-discount" class="accordion-body collapse">
														<div class="panel-body">
															<div class="coupon">
																<label for="coupon_code"><?php _e( 'กรอกคูปอง :', 'porto' ); ?></label>
																<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" />
																<input type="submit" class="btn btn-primary" name="apply_coupon" value="<?php esc_attr_e( 'ใช้คูปอง', 'porto' ); ?>" />
